...
export default function Home() {
  ...
  return (
    <div style={{backgroundColor: "#860F09"}} className="min-h-screen full-width">
      ...
      <p style={{color: "#FDEDD6",fontFamily: jost.style.fontFamily, fontWeight: 300}} className='text-2xl ml-10 mt-16 w-3/5'>All Thyme Recipes eliminates all your food waste problems. You'll save time and money with our recipes custom tailored for the ingredients in your pantry. Log in with the button below.</p>
